...
########################################################################################################
## 这是在ds4-sm120-preview-dev，我自己改的分支下面跑的数据：
#   cards   VRAM_RATE   Context_Length  Concurrency     Prefill-Speed   Decode-Speed
#   4       0.91        1M              6.0x
#   4       0.95        1M              6.4x
#   4       0.5         512k            1.35x
#   4       0.6         512k            3.29x            
#   4       0.95        512k            10.13x         0.69s             86t/s
#******************************************************************************************************
## 这是在review-upsteam-ds4-sm120，即2026-07-27从jasl/vllm:ds4-sm120-preview-dev拉取的分支跑的数据:
#   4       0.95        512k            8.83x          6.79s             48t/s (同一个部署脚本，同一个提示词）
#
########################################################################################################   
